 ...
 * @author Muiz
 */
public class BusEntry2 extends javax.swing.JFrame {
    ...
    public BusEntry2(String username, String bname, String cid) {
        this.companyID = cid;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
			...
			try
			{
				...
				var =  companyID + ",'" + licensePlateNo + "' ," + seatCapacity + ",0" + " , 0 ," + routeID + ", 'null', 'null',"
						+ " " + driverID + ", " + assistantID + ", '0', '1' ";	
				query = "INSERT INTO bus(company_id,Licence_plate_no,seat_capacity,seat_taken,passenger_count,route_id,bus_status,current_location,driver_id,assistant_id,trip_count_per_day,available) "
						+ " VALUES(" + var + ")";
    ...
    public static void main(String args[]) {
         ...
         */
            try {
                ...
                java.util.logging.Logger.getLogger(BusEntry2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
