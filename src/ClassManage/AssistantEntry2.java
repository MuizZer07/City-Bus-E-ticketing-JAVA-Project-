 ...
 * @author Muiz
 */
public class AssistantEntry2 extends javax.swing.JFrame {
    ...
    public AssistantEntry2(String username, String bname, String cid) {
        this.companyID = cid;
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(aPasswordText, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
			...
			try
			{
				...
				var = "'" + assistantName + "','" + aUserName + "' ,'" + aPassword + "',0," + "'" + since + "'," + "0," + companyID + ",0";	
...
//				query3 = "select count(id) from assistant ;";
                                query3 = "select id from employee where username = '" + aUserName + "'";
				...
				query1 = "INSERT into assistant(employee_id) values(" + temp + ");";
    ...
    public static void main(String args[]) {
         ...
         */
            try {
                ...
                java.util.logging.Logger.getLogger(AssistantEntry2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
